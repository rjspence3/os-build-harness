...
| **AI Model binding** | **Portal-only at banking-build time — bind AIModelConnection to agent AIModel slot** | **THE MCP WALL: not reference-able → OS-APPS-40028 "AIModel must be set" (RE-VERIFYING live 2026-07-05 — user reports possibly lifted)** | 17, MEMORY ai_model_binding_portal_only |
